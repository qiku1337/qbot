;adressy zmiennych
global $clientexe_global = "RealestaDX9"
global $key_global = "RealEncounter"
global $servername_global = "Realesta7.4"

global $mana_static = 0x00493EB8
global $mana_offset[2] = [Null, Dec("3D0")]

global $hp_static = 0x00493EB8
global $hp_offset[2] = [Null, Dec("398")]

global $name_static = 0x00493EB8
global $name_offset[2] = [Null, Dec("FC")]

global $cap_static = 0x00493EB8
global $cap_offset[2] = [Null, Dec("3A8")]

global $light_static = 0x00493EB8
Global $light_offset[2] = [Null, Dec("A4")]

global $rslot_static = 0x00493EB8
...
global $iflogin_static = 0x002433A4
global $iflogin_offset[2] = [Null, 4]
