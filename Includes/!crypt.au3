...
#AutoIt3Wrapper_Outfile_x64=crypt_euronia.Exe
...
;#include <Address/address_Nostalrius.au3>
#include <Address/address_WAT.au3>
;#include <Address/address_Retrocores.au3>
;#include <Address/address_Nostalrius.au3>
;#include <Address/address_Nostalrius.au3>
;#include <Address/address_prio.au3>
...
Func Example()
    Local $hGUI = GUICreate($key_global, 400, 470)
    ...
    $g_hKey = _Crypt_DeriveKey(StringToBinary($key_global), $iAlgorithm) ; Declare a password string and algorithm to create a cryptographic key.
    ...
    While 1
        Switch GUIGetMsg()
            ...
            Case $idCombo ; Check when the combobox is selected and retrieve the correct algorithm.
                ...
                $g_hKey = _Crypt_DeriveKey(StringToBinary($key_global), $iAlgorithm) ; Re-declare a password string and algorithm to create a new cryptographic key.
